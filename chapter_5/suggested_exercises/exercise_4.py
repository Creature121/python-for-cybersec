...
PythonLibraryMistmatch.py currently detects subordinate modules such
as B in from A import B. Update the code so that subordinate modules
are included only if the code imports them as from A import B.
