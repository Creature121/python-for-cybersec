...
def encrypt(plain_text):
    padding = " " * (16 - len(plain_text) % 16) # no padding in the og code, manually added
...
while True:
    ...
    if code == "Decrypt files":
        ...
        for path in paths:
            ...
            decryptFile(file_name) # says decryptFile(path) in the book, pretty sure its file_name...
        break
